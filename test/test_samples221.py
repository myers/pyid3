...
__revision__ = "$Id: test_samples221.py,v 1.2 2004/03/02 05:26:07 myers_carpenter Exp $"
...
class ID3v221SamplesTestCase(unittest.TestCase):
    def setUp(self):
        pass
...
def suite():
    suite = unittest.makeSuite(ID3v221SamplesTestCase, 'test')
